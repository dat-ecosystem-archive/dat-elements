...
function circleElement (peer, opts) {
  var prog = peer.have * 100 / peer.blocks
  return html`
    <div class="${prefix} mr5 dib dat-progress-circle" style="animation-delay: ${-prog}s">
      <div class="dat-progress-circle__progress">
        <span class="f3">${prog === 100 ? 100 : prog.toFixed(2)}%</span>
      </div>
    </div>
  `
}
